setTimeout(function () {
   ...
   if (document.querySelector('#page_layout .audio_page_player2')) {
      ...
      // == Меняем тень при смене обложки - player fixed
   ...
   // === Create box-shadow (copy cover) in page Music - Header
   // Audio group buttons in header
